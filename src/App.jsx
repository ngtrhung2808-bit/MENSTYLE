...
export default function App() {
  return (
    <div className="min-h-screen flex flex-col bg-neutral-50 selection:bg-amber-500 selection:text-neutral-950 font-sans">
      {/* 1. Header Navigation */}
      <Header />
      ...
      <main className="flex-1">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-neutral-900 mt-1">Được Phái Mạnh Ưa Chuộng</h2>
            </div>
            <div className="flex items-center gap-2">
              ...
              <Button variant="ghost" size="sm" className="rounded-full text-rose-600 font-semibold">Khuyến mãi</Button>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <Button variant="outline" size="lg" className="rounded-full border-neutral-300 px-8 hover:border-neutral-900 font-bold">
        ...
        <section className="bg-neutral-950 text-white py-16 px-4 sm:px-6 lg:px-8 mt-12 border-t border-neutral-800">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            <h2 className="text-3xl font-black tracking-tight">Gia Nhập Cộng Đồng Quý Ông MENSTYLE</h2>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row gap-2.5 max-w-md mx-auto pt-4">
              <input
                ...
                className="flex-1 bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-sm placeholder:text-neutral-400 focus:outline-none focus:border-amber-400 text-white"
              />
              <Button variant="primary" size="md" className="rounded-xl px-6 bg-amber-500 hover:bg-amber-600 text-neutral-950 font-bold">
                Đăng ký ngay
              </Button>
            </form>
          </div>
